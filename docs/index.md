...
!!! info "Как смотреть демо"
    ...
    3. Откройте вкладку **«Подача вина»** — правила температуры, бокалов, декантации и порядка подачи для официантов.
    4. Попробуйте **поиск** (значок лупы вверху страницы) — введите, например, «Шабли» или «фондан».
